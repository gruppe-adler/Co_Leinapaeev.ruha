...
if (hasInterface) then {
    ...
    private _iconHeli = "\A3\ui_f\data\igui\cfg\mptable\air_ca.paa";
    private _iconTotal = "\A3\ui_f\data\igui\cfg\mptable\total_ca.paa";
    

    private _columns = ["", "Russland", "Estland"];
    ...
    */
    ...
    private _resultTotalNumber_west = ((parseNumber _resultInf_west) + (parseNumber _resultSoft_west) + (parseNumber _resultAPC_west) + (parseNumber _resultArmored_west) + (parseNumber _resultHeli_west));
    private _resultTotalNumber_east = ((parseNumber _resultInf_east) + (parseNumber _resultSoft_east) + (parseNumber _resultAPC_east) + (parseNumber _resultArmored_east) + (parseNumber _resultHeli_east));
