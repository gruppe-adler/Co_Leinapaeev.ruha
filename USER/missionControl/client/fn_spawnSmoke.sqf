...
_colorBlue = 0;
_colorAlpha = 1;
_particleLifeTime = 90; //50, 5 is HUGE amount of smoke, so lower is more
...
_emitterSmoke setParticleParams [["\A3\data_f\ParticleEffects\Universal\Universal_02",8,0,40,1],"","billboard",1,_particleLifeTime,[0,0,0],[0,0,2*_particleSpeed],0,0.05,0.04*_particleLifting,0.05*_windEffect,
        ...
        1.9 * _particleSize + 20,
        2 * _particleSize + 25,
        2.2 * _particleSize + 30,
        2.6 * _particleSize + 35,
        3 * _particleSize + 40,
        3.5 * _particleSize + 45,
        5 * _particleSize + 50
        ],
        [
            ...
            [0.84*_colorRed,0.84*_colorGreen,0.84*_colorBlue,0.4*_colorAlpha],
            [0.84*_colorRed,0.84*_colorGreen,0.84*_colorBlue,0.2*_colorAlpha],
            [0.84*_colorRed,0.84*_colorGreen,0.84*_colorBlue,0.1*_colorAlpha],
            [1*_colorRed,1*_colorGreen,1*_colorBlue,0.01*_colorAlpha],
            [1*_colorRed,1*_colorGreen,1*_colorBlue,0*_colorAlpha]
        ],
        [1,0.55,0.35], 0.1, 0.08*_expansion, "", "", ""];
_emitterSmoke setParticleRandom [_particleLifeTime/4, [0.2*_effectSize,0.2*_effectSize,0.2*_effectSize], [0.2,0.2,0.3], 1, 0, [0.1,0.1,0.1,0.06], 0, 0];
